...
## File: apps/web/src/shared/lib/utils.ts
...
## File: apps/web/src/shared/ui/badge.tsx
...
## File: apps/web/src/shared/ui/calendar.tsx
...
## File: apps/web/src/shared/ui/card.tsx
...
## File: apps/web/src/shared/ui/dialog.tsx
...
## File: apps/web/src/shared/ui/dropdown-menu.tsx
...
## File: apps/web/src/shared/ui/input.tsx
...
## File: apps/web/src/shared/ui/label.tsx
...
## File: apps/web/src/shared/ui/select.tsx
...
## File: apps/web/src/shared/ui/separator.tsx
...
## File: apps/web/src/shared/ui/sheet.tsx
...
## File: apps/web/src/shared/ui/sonner.tsx
...
## File: apps/web/src/shared/ui/textarea.tsx
...
## File: apps/web/src/shared/ui/toast.tsx
...
```json
{
  ...
  "scripts": {
    ...
    "build": "next build",
    "build:gh-pages": "NEXT_PUBLIC_BASE_PATH=/shifts-app next build",
    "start": "next start",
    "lint": "eslint .",
...
// ─── PresetMeta (ключ к правильной ротации) ──────────────────
...
```json
{
  ...
  "scripts": {
    "dev": "pnpm --filter @shifts/web dev",
    "dev:clean": "pnpm --filter @shifts/web exec rm -rf .next && pnpm --filter @shifts/web dev",
    "build": "pnpm --filter @shifts/web build",
    "build:gh-pages": "NEXT_PUBLIC_BASE_PATH=/shifts-app pnpm --filter @shifts/web build",
    "clean": "pnpm --filter @shifts/web exec rm -rf .next out",
    "lint": "pnpm -r lint",
